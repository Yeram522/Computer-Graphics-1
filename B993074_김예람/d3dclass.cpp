						  ...
						  float screenDepth, float screenNear)
{
	...
	D3D11_BLEND_DESC blendStateDescription; //알파 블랜딩
	...
	//파티클들이 겹칠 때 서로 블랜딩하게 해야하기 때문에
	//블랜드 상태를 파티클에 맞게 설정해야한다.
	...
	// description을 수정하여 알파를 사용하지 않도록 만든다.
