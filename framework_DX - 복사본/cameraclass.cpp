...
{
	XMVECTOR result = XMVectorSet(m_positionX, m_positionY, m_positionZ, 1.0f);
	return result;
}
...
{
	XMVECTOR result = XMVectorSet(m_rotationX, m_rotationY, m_rotationZ, 1.0f);
	return result;
}
...
//void CameraClass::GetViewMatrix(XMVECTOR& viewMatrix)
//{
